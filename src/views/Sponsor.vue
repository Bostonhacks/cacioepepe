          ...
          <v-col cols="12" md="4" class="d-flex flex-column justify-center">
            <div>
              ...
              <p class="display-1 text-left body-1 pt-4">
                ...
                exhilarating 24 hours to build awesome projects. In our past two
                events, students had meaningful interactions with mentors,
                peers, and sponsors. A hackathon would be incomplete without the
                new technology, advice, and ideas our sponsors offer, and we’d
                be eager to have you join us this coming Fall!
                <br />
                <br />BostonHacks Fall 2020 will run from November 14th to
                Sunday, November 15th on Boston University’s Charles River
                campus. At BostonHacks, we strive to provide a comprehensive
                recruiting and branding experience to our sponsors. Here’s what
                your company can do at our event.
              </p>
            </div>
          </v-col>
        </v-row>
        <v-row justify="center" no-gutters>
          <v-col cols="12" md="8">
            ...
            <p>
              ...
              and get a sense of emergent technologies. Collaborate with
              students on a more intimate level at our comfortably mid-sized
              hackathon. Offer students advice and/or tech to help them through
              their projects. Whether you’re looking for brand awareness,
              technical expertise or personal development, you’ll find it
              here—with 500 motivated hackers and dozens of skilled mentors.
            </p>
            ...
            <p>
              ...
              candidate. Plus, you’ll have access to a group of students that
              are extraordinarily passionate about what they do, and a friendly
          ...
          <v-row class="justify-space-between">
            <v-col cols="12" md="3">
              ...
              <p>
                ...
                sponsor. If you’d like to email students directly, see the $5k
                and $7.5k tiers.
              </p>
            </v-col>
            <v-col cols="12" md="3">
              ...
              <p>
                This can be a fun, non-hacking virtual challenge e.g. giving out
                a puzzle to solve, a coding challenge, or asking attendees to
                answer a fun question or send in a photo of themselves doing a
                challenge. Or, you could also host a workshop on an API or
                technology you might want to present.
              </p>
            </v-col>
            <v-col cols="12" md="3">
              ...
              <p>
                ...
                your company branding at public fall events such as the BU
                student activities fair (attended by thousands of BU students).
              </p>
            </v-col>
          </v-row>
        </v-col>
