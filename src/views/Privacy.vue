<template>
  <main class="pt-70px">
    <div class="white pt-8">
      <v-container>
        <v-row
          class="flex-column-reverse flex-md-row pb-8"
          justify="center"
          no-gutters
        >
          <v-col cols="12" md="6" class="d-flex flex-column justify-center">
            ...
            <ul>
              ...
              <li>
                <p>
                  ...
                  Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                  &quot;Our&quot; in this Agreement) refers to BostonHacks, 1
                  Silber Way, Boston, MA 02215.
                </p>
              </li>
              <li>
                <p>
              ...
              <li>
                <p>
                  <strong>Website</strong> refers to BostonHacks, accessible
                  from
                  <a
                    href="https://bostonhacks.io"
                    rel="external nofollow noopener"
                    target="_blank"
                    >https://bostonhacks.io</a
                  >
                </p>
              </li>
              <li>
            ...
            <ul>
              <li>By email: contact@bostonhacks.io</li>
            </ul>
          </v-col>
        </v-row>
      </v-container>
