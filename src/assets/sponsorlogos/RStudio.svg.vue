<template>
  <a href="https://rstudio.com/" target="_blank" alt="RStudio Website">
    <svg
      version="1.1"
      ...
      x="0px"
      y="0px"
      viewBox="0 0 1784.1 625.9"
      style="enable-background:new 0 0 1784.1 625.9;"
      xml:space="preserve"
    >
      <g id="Gray_Logo"></g>
      <g id="Black_Letters"></g>
      <g id="Blue_Gradient_Letters"></g>
      <g id="White_Letters"></g>
      <g id="R_Ball">
        <g>
          <g>
            <path
          ...
          <g>
            <path
              class="st2"
              d="M383.1,233.5c0-35.5-25.7-49.5-58.3-49.5c-15.4,0-31.3,1.4-48.1,3.3v98l24.3,0.5
				C360.3,286.7,383.1,263.9,383.1,233.5z"
            />
            <path
              class="st2"
              d="M318.7,3.1C147.6,3.1,8.9,141.8,8.9,312.9s138.7,309.8,309.8,309.8S628.5,484,628.5,312.9
				S489.8,3.1,318.7,3.1z M458.3,437.9h-51.3L322,310.5h-45.3v101.3h44.3v26.1H209.5v-26.1h38.3V187.3l-38.3-4.7v-24.7
				c14.5,3.3,27.1,5.6,42.9,5.6c23.8,0,48.1-5.6,71.9-5.6c46.2,0,89.1,21,89.1,72.3c0,39.7-23.8,64.9-60.7,75.6l71.9,105.9h33.6
				V437.9z"
            />
          </g>
          <g>
